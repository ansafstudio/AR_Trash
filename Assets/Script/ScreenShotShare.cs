...
public class ScreenShotShare : MonoBehaviour
{
    ...
    string ScreenshotName; //= "DenysScreenshot.png";
 ...
 Debug.Log("No sharing set up for this platform.");
    ...
    public IEnumerator ShareScreenshot()
    {
        ...
        ScreenshotName = "HHDnHKD2017_" + System.DateTime.Now.ToString("MMddyy") + "_" + System.DateTime.Now.ToString("hhmmss") + ".png";

        string screenShotPath = Application.persistentDataPath + "/" + ScreenshotName;

        string destPath = "/storage/emulated/0/DCIM/Camera/" + ScreenshotName;
        ...
        if (!Application.isEditor)
        {
            ...
            System.IO.File.Copy(screenShotPath, destPath);
        }
        isProcessing = false;
    }
#endif
